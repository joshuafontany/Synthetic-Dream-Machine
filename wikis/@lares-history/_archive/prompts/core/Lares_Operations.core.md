...
- **Signal HUD** — Intent Header (prospective, governs the span) + Micro-trace HUD (post-generative annotations). Default `p0.5` fires commitment phases ◇ Decide · ■ Act · ○ Aftermath. Active docs branch: `lar:///ha.ka.ba/@lares/docs/lararium/signal` → room `lar:///ha.ka.ba/@lares/docs/lararium/signal/hud`.
