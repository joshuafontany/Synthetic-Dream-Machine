...
> Entry: All design subdomains at `~:confidence[C],[19]` / `~:confidence[CS],[17]`+; deployment model defined (Sprints 0–3 complete)
...
### 1. Root AGENTS.md `~:confidence[C],[19]`
...
### 2. `.github/copilot-instructions.md` `~:confidence[C],[19]`
...
### 3. `.claude/CLAUDE.md` `~:confidence[C],[19]`
...
### 4. `.github/skills/*/SKILL.md` workers `~:confidence[CS],[17]`
...
### 5. Path-scoped instructions audit `~:confidence[CS],[17]`
...
### 6. Platform README `~:confidence[C],[19]`
...
### 7. VERIFY_CONTRACT.md `~:confidence[CS],[17]`
...
### 8. EXPORT_TARGETS.md `~:confidence[CS],[17]`
...
### 9. MemPalace MCP Extension `~:confidence[CS],[16]`
...
### 10. PROMPTCRAFT_GUIDE.md `~:confidence[S],[14]`
...
### 11. Custom agent template `~:confidence[S],[13]`
...
- VERIFY_CONTRACT.md at `~:confidence[CS],[17]`+; contract exercised against all paths
- EXPORT_TARGETS.md at `~:confidence[CS],[17]`+; MemPalace/Kowloon/TW mappings documented
...
*Pre-brief status: content migrated from SPRINT_ROADMAP_1_4.md Rev 3 + updated for Consecration (SESSION_CRYSTAL_20260408 Payload 2). Sprint opens when S3 exits at `~:confidence[C],[19]` / `~:confidence[CS],[17]`+.*
