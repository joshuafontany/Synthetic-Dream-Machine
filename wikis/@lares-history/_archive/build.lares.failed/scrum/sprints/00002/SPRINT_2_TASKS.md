...
> Entry: URI + crystal at `[C~19]` (Sprints 0 + 1 complete)
...
### 1. INVARIANTS.md `[C~19]`

- `lares.core.*` behavioral invariant registry — 8 invariants from D-report TOML. Workers **validate against Kernel `[C~20]` tags; do not derive from scratch**.
...
### 3. BIDIRECTIONAL_PROTOCOL.md `[CS~17]`
...
### From E-deep-research-report.md `[S~14]` — 40+ source synthesis
...
### From D-deep-research-report.md `[CS~16]`
...
### From LIMINAL_PERSPECTIVES.md `[S~13]` (this folder, Sprint 0)
...
|---|---|---|---|
| `D_deep-research-report.md` | `[CS~16]` | INV-01, INV-02 | **Start here** |
| `EP-RA-001.md` v3 | `[CS~17]` | INV-05, SIG-04, SIG-08 | **Start here for HUD** |
| `E-deep-research-report.md` | `[S~14]` | P_BAND_MODEL.md, INTENT_HEADER.md | **Start here for both** |
| `A_deep-research-report.md` | `[S:]` | Invariant grounding (not canon) | Secondary |
| `C_deep-research-report.md` | `[CS~16]` | TOML manifest examples (informs INV structure) | Secondary |
| `TRUST_MODELS.md` | — | Trust model | Load |
| `TODO_Resolution_Scale_Design.md` | — | p-band model source | Load |
| Kernel `[C~20]` tags | `[C~20]` | Invariant registry must align; **Kernel wins on conflict** | Always-on |
| `../00000/LIMINAL_PERSPECTIVES.md` | `[S~13]` | SHD-01/02/03, progressive disclosure | Supplemental |
...
- INVARIANTS.md at `[C~19]` (operator-confirmed); all 8 `lares.core.*` invariants against Kernel
- TRUST_MODEL.md at `[C~19]`
- BIDIRECTIONAL_PROTOCOL.md at `[CS~17]`+
- INTENT_HEADER.md at `[CS~17]`+; SAOD pass completed
- P_BAND_MODEL.md at `[CS~17]`+; mana pool element + token budget framing included
...
*Pre-brief status: content migrated from SPRINT_ROADMAP_1_4.md Rev 3 + updated for Consecration (SESSION_CRYSTAL_20260408 Payload 2). Sprint opens when S1 exits at `[C~19]`.*
