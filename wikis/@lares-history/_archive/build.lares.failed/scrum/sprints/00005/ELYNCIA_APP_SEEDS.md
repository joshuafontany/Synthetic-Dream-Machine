...
> Register: `~:confidence[S],[12]` 🏛️🌊 — seeds, not architecture; the abstraction layer underneath the storytelling
> Date: 2026-04-08
...
|---|---|---|---|
| DECK-01 | TiddlyWiki bag-and-recipe model for dreamdeck composition | `~:confidence[SP],[9]` | S5+ |
| DECK-02 | tldraw shape format for HUD tag rendering | `~:confidence[SP],[8]` | S5+ |
| DECK-03 | Kowloon ActivityPub integration for feed archives | `~:confidence[SP],[9]` | S5+ |
| DECK-04 | AT Protocol DID → Lares alias mapping | `~:confidence[SP],[8]` | S5+ |
| DECK-05 | "Live DreamDeck" prototype: tldraw canvas + Kowloon feed + TiddlyWiki sidebar | `~:confidence[P],[6]` | S5+ |
| DECK-06 | Dream-realm streaming (Twitch-like for tabletop/video games on DreamNet) | `~:confidence[P],[5]` | S6+ (distant) |
| DECK-07 | Lindwyrm origin story as native Kowloon/ActivityPub thread | `~:confidence[S],[11]` | S4 or S5 |
