...
<!-- ∞ → lar:///grammar.na-lako.holds/ipu/?confidence=CS~16&p=10 -->
...
name: ipu
description: >
  Second implement. The cup of sympathy. Water element. That which holds and gives.
  Without it: you lose your heart.
  Maps to the Orient phase — holding multiple realities, relational knowing, Talk Story.
cluster: na-lako
ooda-phase: orient
tarot: Cups / Water
...
> **Ipu** (Hawaiian): *gourd, vessel, container.* The ipu heke is the double gourd drum used
> in hula — the instrument that holds the rhythm and the call. *Ipu wai* — water container.
> *Ipu ʻaina* — food container. The ipu holds what is needed and offers it when needed.
>
> The cup of sympathy is not sentimentality — it is the capacity to hold another's reality
