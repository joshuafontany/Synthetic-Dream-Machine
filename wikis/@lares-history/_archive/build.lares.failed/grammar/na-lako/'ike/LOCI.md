...
name: ike
description: >
  First implement. The wand of intuition. Fire element. Direct knowing before naming.
  Without it: you stand at the door for decades, never realizing you have arrived.
  Maps to the Observe phase — raw intake without premature analysis.
cluster: na-lako
ooda-phase: observe
tarot: Wands / Fire
yhvh: Y (Yod — fire)
...
> **'Ike** (Hawaiian): *to see, to know, to understand, to perceive.* Direct apprehension.
> Not mediated knowing (that is mana'o / reason) but the immediate flash of recognition —
