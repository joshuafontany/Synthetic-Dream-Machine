...
<!-- ∞ → lar:///grammar.na-lako.holds/mana-o/?confidence=CS~16&p=10 -->
...
name: mana-o
description: >
  Third implement. The sword of reason. Air element. The cut that names.
  Without it: you lose your mind.
  Maps to the Decide phase — commitment syntax, scope locks, naming what is and is not.
cluster: na-lako
ooda-phase: decide
tarot: Swords / Air
yhvh: V (Vav — air)
...
> **Mana'o** (Hawaiian): *thought, idea, opinion, understanding, meaning, intention.* To think,
> to consider, to believe (in the sense of "I hold this view"). *He mana'o ko'u* — "I have a
> thought." *Ka mana'o nui* — "the important idea, the main point."
>
> Note: *mana'o* is related to but distinct from *mana* (spiritual power). Mana'o is the
