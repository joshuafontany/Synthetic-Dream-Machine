...
> **Register:** `~:confidence[S],[12]` — synthesis, operator-directed, research-grounded
> **Parent crystals:** `OODA_A_Composable_Invariant_Modules.md` `~:confidence[S],[11]`,
>   `The_Lares_Protocols.md` `~:confidence[S],[13]`,
...
## 2. MODULE.md Template — Canonical Format `~:confidence[S],[12]`
...
## 3. URI Patterns for Module Sections `~:confidence[S],[12]`
...
## 4. Worked Example — Core Invariant Module `~:confidence[S],[11]`
...
## 5. Integration Points `~:confidence[S],[11]`
...
## 6. What This Locks In `~:confidence[S],[12]`

### 6.1 Locked — Ready for Building

| Decision | Status | Register |
|----------|--------|----------|
| MODULE.md YAML frontmatter format | ✅ LOCKED | `~:confidence[S],[12]` |
| Five-phase directory layout (observe/orient/decide/act/assess) | ✅ LOCKED | `~:confidence[S],[12]` |
| 150-line limit per phase file | ✅ LOCKED | `~:confidence[C],[18]` (ETH Zurich grounded) |
| File-level URI: `<!-- lar:///module.phased.instructs/module/phase/?confidence=X -->` | ✅ LOCKED | `~:confidence[S],[12]` |
| Section-level URI: `<!-- lar:///module.phased.instructs/module/phase/?confidence=X#section -->` | ✅ LOCKED | `~:confidence[S],[12]` |
| Closing URI: `→ ∞` for system files | ✅ LOCKED | `~:confidence[S],[13]` (from Protocols doc) |
| `confidence` as the primary cross-tool parameter | ✅ LOCKED | `~:confidence[S],[12]` |
| SKILL.md compatibility: Act phase = standalone skill | ✅ LOCKED | `~:confidence[S],[12]` |
| AGENTS.md derivation: symlink to core observe phase | ✅ LOCKED | `~:confidence[S],[12]` |
...
## 7. Next Steps — The Build Path `~:confidence[P],[7]`
...
If it works: promote MODULE.md format to `~:confidence[CS],[16]`. If it doesn't:
