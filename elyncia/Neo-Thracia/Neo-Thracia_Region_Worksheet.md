...
* **Material conditions (adventure always happens):**
  1. contested travel chokepoints (rift mazes; river gates; broken road networks)
  2. decaying magitech + “iron failure” constraints
  3. cult schisms + necro-script infiltration
  4. resettlement pressure in the delta/coast regions + human/fae/beastfolk polities inland
...
1.  Choose **Mode** (column) by fiction: **Day / Night / Mists / Riftglow**.
2.  Roll **d6 intensity**:
...
* **What it does at the table:**
  ...
  * assigns a cost vector: time / attention / oath / contamination / iron-decay escalation
    This generator is especially good for making the “DEM map base” feel *alive* without rewriting geography every session.
...
Purpose: make movement political. Every route has: type, status (legal/taboo/restricted), and price (coin/favor/permit/oath).
Neo-Thracia’s travel ideology hook: “movement requires authorization because movement equals contagion (necro-scripts, rift hitchhikers, iron curse spread).”
