/**
 * browser-sensorium-island.mjs — a REAL Web Worker island carrying the S2 sensorium cap.
 *
 * Proves the S3 supervision wire in Chromium without a TW5 boot: the worker stands the S0 GLUE
 ...
 *   sensorium:*          -> cap.onSignal (the S2 surface, un-re-implemented) -> event(sensorium:frame)
...
self.addEventListener("message", (e) => {
  ...
  // the S2 signal surface, ridden verbatim: the wire message's TYPE names the signal, and the cap
