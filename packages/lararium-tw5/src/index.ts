...
export { VerbDispatcher, VerbTable, VERB_SURFACE } from "./verb-dispatcher.js";
export type { VerbContext, VerbReactor, VerbDispatcherOptions, VerbSpec } from "./verb-dispatcher.js";
