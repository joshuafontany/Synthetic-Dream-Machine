  ...
  readonly tiddlerTexts = new Map<string, string>([
    [
      ...
      [
        ...
        "[prefix[$:/StoryList]then[lar:///ha.ka.ba/@personal]]",
        "[prefix[$:/state/folded/]then[lar:///ha.ka.ba/@personal]]",
        "[prefix[$:/state/tab-]then[lar:///ha.ka.ba/@personal]]",
        "[prefix[$:/palette]then[lar:///ha.ka.ba/@personal]]",
