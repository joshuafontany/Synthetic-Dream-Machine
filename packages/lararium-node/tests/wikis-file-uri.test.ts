...
describe("wikisFileToUri — @working ingest-back reverse-derivation", () => {
  test("the wiki-slug dir strips; the interior IS the name", () => {
    expect(wikisFileToUri(ROOT, "/srv/vessel/wikis/@lares/ha.ka.ba/@lares/api/pono/meme.md"))
      .toBe("lar:///ha.ka.ba/@lares/api/pono/meme");
  });

  test("a minted user wiki's @working surface derives losslessly", () => {
    expect(wikisFileToUri(ROOT, "/srv/vessel/wikis/@my-world/ha.ka.ba/@lararium/tw5/recipe-watch.md"))
  ...
  test("rootless interior, non-.md, outside wikis/ → null (skipped, never guessed)", () => {
    ...
    expect(wikisFileToUri(ROOT, "/srv/vessel/wikis/@lares/api/pono/meme.md")).toBeNull();
    // non-.md
    ...
    expect(wikisFileToUri(ROOT, "/srv/vessel/bags/@lares/ha.ka.ba/@lares/api/pono/meme.md")).toBeNull();
