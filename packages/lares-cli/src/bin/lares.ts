...
const COMMANDS: readonly Command[] = [
  ...
  { name: "normalize",     summary: "Canonicalize a meme carrier's framing — the iam namespace into the SOH, the declaration to the one that names the grammar — so the round-trip laws hold. `--check` reports drift without writing (CI/pre-commit).", handler: cmdNormalize     },
