/**
 * Causal Island primitives — ontological law and federation-authority types.
 *
 ...
 * not authority.
 *
 * SCOPE NOTE (S11-collapse YIN pass): this file carries the federation-AUTHORITY
 * doctrine — principals, the access ladder, caveats, capabilities, edge islands,
 * the visibility gate, and authority-first sync ordering. The live capability gate
 * has moved to capability.ts / carriage-caps.ts (keyhive-backed); the Orichalcum
 * types here give the edge-island federation scaffolding a typed vocabulary and
 * survive as spec exercised by the unit test. The residency RUNTIME (wela/anu
 * BagResidencyManager) — formerly glued onto the tail of this file — now lives in
 * bag-residency.ts, its own home.
 */
...
// with bag CRDT history — no centralized receipt registry. The residency
// RUNTIME itself lives in bag-residency.ts.
// ---------------------------------------------------------------------------
