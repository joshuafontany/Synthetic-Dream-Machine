...
import {
  ...
  sealLineageHead, emptyFoundingCharterDoc, NEXUS_CHARTER_DOC_KIND, type NexusDoc,
...
describe("rosterFromNexusDoc — the PRE-ROTATED CHAIN roots the antigen on the verified HEAD (#68)", () => {
  ...
  async function chainedDoc(seedsA: Uint8Array[], seedsB?: Uint8Array[]): Promise<NexusDoc> {
    ...
    return { kind: NEXUS_CHARTER_DOC_KIND, threshold: 2, sealEpochCid: head.epochCid, sealLineage: chain, kahu };
  }
