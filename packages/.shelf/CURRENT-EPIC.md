...
> ⚠ **DOUBLY STALE (design archive since 2026-05-27; the whole packages/ handoff layer froze 2026-06-07).** The live handoff is the bags pantjar torch: `bags/lares/ha.ka.ba/lares/docs/handoff.md`. Treat this file as deep design archaeology only.
