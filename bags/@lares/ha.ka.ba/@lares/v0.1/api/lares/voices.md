...
**Mask definition file** — canonical home in `lar:///ha.ka.ba/@lares/v0.1/api/lares/masks/**`. Definition never travels.
...
Tool-carry pairs apply per the stance law (`lar:///ha.ka.ba/@lares/v0.1/api/mu/the-four-tools`). Stance law MAY be revised; this rule follows it.
...
All mask definitions live in `lar:///ha.ka.ba/@lares/v0.1/api/lares/masks`. Parent index at `lar:///ha.ka.ba/@lares/v0.1/api/lares/masks` routes to three subtrees:
