...
English alias for `wai`, the wikispace conditional. See the canonical spec:

<<~ aka lar:///ha.ka.ba/@lares/v0.1/api/pono/wai >>

`\if` and `wai` share identical semantics. Both test a TW5 filter condition and render the
