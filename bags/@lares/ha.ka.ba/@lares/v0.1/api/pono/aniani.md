...
<<~ ॐ ँ&#x0001; ? -> lar:///ha.ka.ba/@lares/v0.1/api/pono/aniani >>
```toml iam
cacheable   = true
file-path   = "bags/@lares/ha.ka.ba/@lares/v0.1/api/pono/aniani.md"
invariant   = false
mana        = 16
manao       = 16
manaoio     = 15
...
## One question, four grammars

The Mirror asks a single thing, in whatever grammar the moment hands it:

- does the law include its own lawgiver?
- does the framer sit inside the frame?
