...
file-path         = "bags/@lares/ha.ka.ba/@lares/v0.1/docs/lararium_mcp.md"
mana              = 16
manao             = 16
manaoio           = 15
...
| `lar:///ha.ka.ba/@lares/**` | file | stable source carriers under `packages/lares-core/memes/v0.1/api/` |
...
| Locus | Canonical role |
|---|---|
| `lar:///ha.ka.ba/@lares/v0.1/docs/graph` | spine — research synthesis, committed decisions, open `? ->` gate |
| `lar:///ha.ka.ba/@lares/v0.1/docs/graph/nodes` | `PranalaEdge`, `CarrierNode`, `CarrierGraph` data model contracts |
| `lar:///ha.ka.ba/@lares/v0.1/docs/graph/traversal` | Tier 0/1/2 walk, DFS cycle detection, Kahn topo sort, declared-unresolved law |
| `lar:///ha.ka.ba/@lares/v0.1/docs/graph/pranala-parser` | block + inline + sugar parser, field normalization, `? ->` gate |
| `lar:///ha.ka.ba/@lares/v0.1/docs/graph/artifacts` | SHA256 content-addressed artifacts, three classes, compaction rules |
