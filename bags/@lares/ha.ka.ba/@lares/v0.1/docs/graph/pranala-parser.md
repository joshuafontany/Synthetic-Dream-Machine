...
```toml iam
file-path   = "bags/@lares/ha.ka.ba/@lares/v0.1/docs/graph/pranala-parser.md"
mana        = 17
manao       = 17
manaoio     = 16
...
```
<<~ ahu #edges >>
  <<~ pranala #preload-l-prime ? -> lar:///ha.ka.ba/@lares/v0.1/api/mu/l-prime family:control role:owns >>
```
...
|---|---|---|
| Full `lar:///` URI | `lar:///ha.ka.ba/@lares/v0.1/api/mu/l-prime` | use as-is |
| Full URI with fragment | `lar:///ha.ka.ba/@lares/v0.1/api/mu#entry` | split into `to_uri` and `to_socket` |
| Relative path | `mu/chao` | prepend current carrier's root (`lar:///ha.ka.ba/@lares/v0.1/api/`) |
