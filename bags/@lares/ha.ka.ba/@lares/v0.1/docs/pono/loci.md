...
```toml iam
cacheable = true
file-path = "bags/@lares/ha.ka.ba/@lares/v0.1/docs/pono/loci.md"
mana      = 18
manao     = 18
manaoio   = 16
namespace = "&#x2299;"
...
- all nine required elements (R1–R9) per `lar:///ha.ka.ba/@lares/v0.1/api/pono/meme`
...
- no outstanding declared-unresolved sub-meme addresses (O7 rule per `lar:///ha.ka.ba/@lares/v0.1/api/pono/meme#optional-elements`)
...
These layer atop the generic meme ratings at `lar:///ha.ka.ba/@lares/v0.1/api/pono/meme#rating-targets`. A local path hit raises evidence; it never overrides honest unresolved tension.

---

## High-Rating Loci Conditions

`lar:///ha.ka.ba/@lares/v0.1/api/pono/meme#rating-targets` governs the generic structural climb. Loci adds routing-and-convention predicates for memes whose carrier identity forms part of the law surface.
...
- `ha-ka-ba/v0.1/api/pono/meme/meme.md` → `ha-ka-ba/v0.1/api/pono/meme.md`
