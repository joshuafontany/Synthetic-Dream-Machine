...
All canonical infrastructure memes live under `lar:///ha.ka.ba/@lares/v0.1/api/`.
...
# The invariant API tuple space root — all ha.ka.ba/@lares/v0.1/api/ memes live here
