...
| Assign `lar:///ha.ka.ba/@lares/api/v0.1/...` URI | — | — | — | ✓ |
...
**Template namespace:** `lar:///ha.ka.ba/@lares/api/v0.1/lararium/templates/` — inside the stable tuple root, no adjacent namespace. `templates/index` owns control edges to all five carriers and is reachable from the `lararium` meme via `#hydrate-templates`.
