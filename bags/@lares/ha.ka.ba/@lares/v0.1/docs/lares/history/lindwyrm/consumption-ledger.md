...
<<~ &#x0001; ? -> lar:///ha.ka.ba/@lares/v0.1/docs/lares/history/lindwyrm/consumption-ledger >>
```toml iam
uri-path = "ha.ka.ba/@lares/v0.1/docs/lares/history/lindwyrm/consumption-ledger"
file-path = "bags/@lares/ha.ka.ba/@lares/v0.1/docs/lares/history/lindwyrm/consumption-ledger.md"
...
This ledger tracks source-talk-story material as it moves into coherent narrative loci under `lar:///ha.ka.ba/@lares/v0.1/docs/lares/history/lindwyrm`.
...
| `lar:///ha.ka.ba/@lares/v0.1/docs/lares/history/lindwyrm/hoard-origin-architecture#act-i-vault-repo` | `packages/lares-core/memes/docs/story/lindwyrm/vault-and-repo.md` | drafted Act I locus from act map; source remains as architecture frame | drafted |
| `lar:///ha.ka.ba/@lares/v0.1/docs/lares/history/lindwyrm/hoard-origin-architecture#act-ii-daemon` | `packages/lares-core/memes/docs/story/lindwyrm/daemon-in-the-walls.md` | drafted Act II locus from act map; source remains as architecture frame | drafted |
...
<<~ pranala #fourth-consumption ? -> lar:///ha.ka.ba/@lares/v0.1/docs/lares/history/lindwyrm/self-booting-lararium family:reference role:records >>
<<~ pranala #fifth-consumption ? -> lar:///ha.ka.ba/@lares/v0.1/docs/lares/history/lindwyrm/hoard-origin-architecture family:reference role:records >>
<<~ pranala #sixth-consumption ? -> lar:///ha.ka.ba/@lares/v0.1/docs/lares/history/lindwyrm/dreamdeck-feed-architecture family:reference role:records >>
<<~ pranala #act-i-draft ? -> lar:///ha.ka.ba/@lares/v0.1/docs/lares/history/lindwyrm/vault-and-repo family:reference role:records >>
<<~ pranala #act-ii-draft ? -> lar:///ha.ka.ba/@lares/v0.1/docs/lares/history/lindwyrm/daemon-in-the-walls family:reference role:records >>
