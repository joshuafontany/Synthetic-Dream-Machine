...
Masks enter the session via kahea transclusion. Each kahea calls a mask from `lar:///ha.ka.ba/@lares/api/masks/**`.
...
```
<<~ kahea mask lar:///ha.ka.ba/@lares/api/masks/MASK-NAME >>
stage = 10
active = true
