...
<<~ &#x0001; ? -> lar:///ha.ka.ba/@lares/library/docs/mu/the-syad-perspectives/STANCE_LOCI >>
```toml iam
cacheable         = false
dependencies      = ["confidence"]
file-path         = "bags/@lares/ha.ka.ba/@lares/library/docs/mu/the-syad-perspectives/STANCE_LOCI.md"
grammar           = true
l-space           = "stable"
...
uri-path          = "ha.ka.ba/@lares/library/docs/mu/the-syad-perspectives/STANCE_LOCI"
```
...
<!-- ahu lar:///grammar.stance.defines/stance/#loop-position -->
...
<!-- ahu lar:///grammar.stance.defines/stance/#handoff -->
...
<!-- ahu lar:///grammar.stance.defines/stance/#surface -->
...
<!-- ahu lar:///grammar.stance.defines/stance/#conventions -->
...
<!-- ahu lar:///grammar.stance.defines/stance/#procedures -->
...
<!-- ahu lar:///grammar.stance.defines/stance/#reading-test -->
...
|---|---|---|
| `LOCI.md` | `Synthesis-Canon 16/20` | This file — stance grammar and Syadasti reading rule |
