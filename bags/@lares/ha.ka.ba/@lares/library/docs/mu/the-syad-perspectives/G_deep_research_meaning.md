...
<<~ &#x0001; ? -> lar:///ha.ka.ba/@lares/library/docs/mu/the-syad-perspectives/G_deep_research_meaning >>
```toml iam
cacheable = false
file-path = "bags/@lares/ha.ka.ba/@lares/library/docs/mu/the-syad-perspectives/G_deep_research_meaning.md"
l-space   = "stable"
...
uri-path  = "ha.ka.ba/@lares/library/docs/mu/the-syad-perspectives/G_deep_research_meaning"
```
