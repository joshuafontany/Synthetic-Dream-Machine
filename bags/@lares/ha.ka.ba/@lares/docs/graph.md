...
The canonical pranala law (`lar:///ha.ka.ba/@lares/api/pono/pranala`) settles this:
...
The canonical loci law (`lar:///ha.ka.ba/@lares/api/pono/loci`) uses **locus / loci** for a carrier in the graph.
