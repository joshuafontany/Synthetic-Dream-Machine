  ...
  "closure": [
    {
      ...
      "implements": ["lar:///ha.ka.ba/@lares/api/pono/meme", "lar:///ha.ka.ba/@lares/api/pono/loci"],
      "depth": 0
    }
  ],
  "locus_count": 14,
...
```json
{
  ...
  "pranala_edges": [
    {
      ...
      "to_uri": "lar:///ha.ka.ba/@lares/api/mu/l-prime",
      "to_socket": "",
      "family": "control",
      "lifecycle": "template",
      "role": null,
  ...
  "interface_index": {
    "lar:///ha.ka.ba/@lares/api/pono/meme": ["lar:///AGENTS", "..."]
  },
  "invariant_index": {
    "lar:///ha.ka.ba/@lares/api/pono/loci": ["lar:///AGENTS", "..."]
  },
  "validation": {
    "all_resolved": true,
    "all_exist": true,
...
```json
{
  ...
  "hash_sequence": [
    ...
    {"uri": "lar:///ha.ka.ba/@lares/api/mu/l-prime", "sha256": "<carrier_hash>", "depth": 1}
  ],
  "validation": {
    "all_resolved": true,
    "all_exist": true,
