...
uri-path                     = "ha.ka.ba/@lares/docs/graph/meme"
```
...
⏿ orient: Bazel's depset pattern informs meme structure; canonical pranala kānāwai (`lar:///ha.ka.ba/@lares/api/pono/pranala`) governs the full PranalaEdge field set and independence law.
...
```json
{
  ...
  "lar:///ha.ka.ba/@lares/api/mu/l-prime": "sha256:..."
}
```
