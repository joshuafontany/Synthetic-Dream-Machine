...
| 2 | `lar:///ha.ka.ba/@lares/api/mu/l-prime` | `packages/lares-core/memes/api/pono/l-prime.md` | `AGENTS#preload-l-prime` |
| 3 | `lar:///ha.ka.ba/@lares/api/mu/ooda-ha` | `packages/lares-core/memes/api/pono/ooda-ha.md` | `AGENTS#preload-ooda-ha` |
| 4 | `lar:///ha.ka.ba/@lares/api/pono/lar-uri` | `packages/lares-core/memes/api/pono/lar-uri.md` | `AGENTS#preload-lar-uri` |
| 5 | `lar:///ha.ka.ba/@lares/api/mu` | `packages/lares-core/memes/api/mu.md` | `AGENTS#threshold-to-mu` |
| 6 | `lar:///ha.ka.ba/@lares/api/mu/chao` | `packages/lares-core/memes/api/mu/chao.md` | Mu internal hydration |
| 7 | `lar:///ha.ka.ba/@lares/api/mu/the-four-tools` | `packages/lares-core/memes/api/mu/the-four-tools.md` | Mu internal hydration |
| 8 | `lar:///ha.ka.ba/@lares/api/mu/the-law-of-5s` | `packages/lares-core/memes/api/mu/the-law-of-5s.md` | Mu internal hydration |
| 9 | `lar:///ha.ka.ba/@lares/api/mu/the-syad-perspectives` | `packages/lares-core/memes/api/mu/the-syad-perspectives.md` | Mu internal hydration |
| 10 | `lar:///ha.ka.ba/@lares/api/lararium` | `packages/lares-core/memes/api/lararium.md` | `AGENTS#threshold-to-lararium` |
| 11 | `lar:///ha.ka.ba/@lares/api/lares/hud` | `packages/lares-core/memes/api/lares/hud.md` | Lararium internal hydration |
| 12 | `lar:///ha.ka.ba/@lares/api/lares/voices` | `packages/lares-core/memes/api/lares/voices.md` | Lararium internal hydration |
| 13 | `lar:///ha.ka.ba/@lararium/tw5/continuity` | `packages/lares-core/memes/api/lararium/continuity.md` | Lararium internal hydration |
...
| `lar:///ha.ka.ba/@lares/**` | file-backed stable tuple root | carrier source truth |
