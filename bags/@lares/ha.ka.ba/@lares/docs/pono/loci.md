...
<<~ ⊙&#x0001; ? -> lar:///ha.ka.ba/@lares/docs/pono/loci >>
```toml iam
cacheable = true
file-path = "bags/@lares/ha.ka.ba/@lares/docs/pono/loci.md"
mana      = 18
manao     = 18
manaoio   = 16
namespace = "&#x2299;"
...
uri-path  = "ha.ka.ba/@lares/docs/pono/loci"
```
...
Extended notes, rating guidance, canon-MOVE criteria, and MCP roadmap for `lar:///ha.ka.ba/@lares/api/pono/loci`.
...
Full five-register rubric at `lar:///ha.ka.ba/@lares/api/pono/meme#rating-targets`. Loci governs routing, convention, and opener changes along the climb from noise to canon.
...
- all nine required elements (R1–R9) per `lar:///ha.ka.ba/@lares/api/pono/meme`
...
- no outstanding declared-unresolved sub-meme addresses (O7 rule per `lar:///ha.ka.ba/@lares/api/pono/meme#optional-elements`)
...
These layer atop the generic meme ratings at `lar:///ha.ka.ba/@lares/api/pono/meme#rating-targets`. A local path hit raises evidence; it never overrides honest unresolved tension.

---

## High-Rating Loci Conditions

`lar:///ha.ka.ba/@lares/api/pono/meme#rating-targets` governs the generic structural climb. Loci adds routing-and-convention predicates for memes whose carrier identity forms part of the law surface.
...
- `ha-ka-ba/api/pono/loci/loci.md` → `ha-ka-ba/api/pono/loci.md`
- `ha-ka-ba/api/pono/meme/meme.md` → `ha-ka-ba/api/pono/meme.md`
- `ha-ka-ba/api/pono/loci/iam/loci-iam.md` → `ha-ka-ba/api/pono/loci/iam.md`
