...
The TOML invariant arrays (`LADDER_5`, `OODA_HA_5`) live in `lar:///ha.ka.ba/@lares/api/pono/memetic-wikitext#law-of-5s`.
...
<<~ loulou lar:///ha.ka.ba/@lares/api/pono/memetic-wikitext#law-of-5s >>
