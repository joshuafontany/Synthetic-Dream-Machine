...
<<~ &#x0001; ? -> lar:///ha.ka.ba/@lares/docs/pono/research-streams/prior-art >>
```toml iam
cacheable   = false
file-path   = "bags/@lares/ha.ka.ba/@lares/docs/pono/research-streams/prior-art.md"
mana        = 16
manao       = 16
manaoio     = 16
...
uri-path    = "ha.ka.ba/@lares/docs/pono/research-streams/prior-art"
```
