...
**Not scope:** Invariant law. See `lar:///ha.ka.ba/@lares/api/pono/memetic-wikitext` for law,
and `lar:///ha.ka.ba/@lares/api/pono/memetic-wikitext` for the full grammar spec.
