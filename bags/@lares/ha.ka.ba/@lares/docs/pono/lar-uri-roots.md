...
```toml iam
cacheable     = true
file-path     = "bags/@lares/ha.ka.ba/@lares/docs/pono/lar-uri-roots.md"
mana          = 18
manao         = 17
manaoio       = 17
...
All canonical infrastructure memes live under `lar:///ha.ka.ba/@lares/api/`.
...
# The invariant API tuple space root — all ha.ka.ba/@lares/api/ memes live here
