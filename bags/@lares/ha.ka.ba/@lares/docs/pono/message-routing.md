...
<<~ &#x0001; ? -> lar:///ha.ka.ba/@lares/docs/pono/message-routing >>
```toml iam
cacheable = false
...
Extended docs for memetic-wikitext's two routing directions on the canvas / flow surface. The family law lives at `lar:///ha.ka.ba/@lares/api/pono/pranala-families`; this surface carries the routing treatment the submission spec abstracts.
