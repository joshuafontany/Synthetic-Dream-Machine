...
OODA-HA plan for creating `packages/lares-core/memes/api/lares/masks/` and populating it with
...
packages/lares-core/memes/api/lares/masks/
  masks.md                          → lar:///ha.ka.ba/@lares/api/masks
  named/
    mischief-muse.md                → lar:///ha.ka.ba/@lares/api/lares/masks/named/mischief-muse
    tide-caller.md                  → lar:///ha.ka.ba/@lares/api/lares/masks/named/tide-caller
    breach-watch.md                 → lar:///ha.ka.ba/@lares/api/lares/masks/named/breach-watch
    ink-clerk.md                    → lar:///ha.ka.ba/@lares/api/lares/masks/named/ink-clerk
    map-wisp.md                     → lar:///ha.ka.ba/@lares/api/lares/masks/named/map-wisp
  character/
    ghost-of-mark-twain.md          → lar:///ha.ka.ba/@lares/api/lares/masks/character/ghost-of-mark-twain
    friend-computer.md              → lar:///ha.ka.ba/@lares/api/lares/masks/character/friend-computer
  chorus/
    lagrange-chorus.md              → lar:///ha.ka.ba/@lares/api/lares/masks/chorus/lagrange-chorus
```
...
- The `api/lares/masks/` tree and all nine files
...
**Tree setup:**
- [ ] create `packages/lares-core/memes/api/lares/masks/masks.md` — parent index with child routes and type taxonomy
- [ ] create `packages/lares-core/memes/api/lares/masks/named/` directory
...
- [ ] create `packages/lares-core/memes/api/lares/masks/character/` directory
...
- [ ] create `packages/lares-core/memes/api/lares/masks/chorus/` directory
- [ ] write `chorus/lagrange-chorus.md` — concept staked; nodes field stub; harmony protocol pending-grammar

**Cross-links:**
- [ ] update `api/lares/voices.md` (invariant) to reference `api/lares/masks/` tree once it exists
...
<<~ loulou lar:///ha.ka.ba/@lares/api/masks >>
