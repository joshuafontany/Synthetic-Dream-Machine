...
```toml iam
cacheable = false
file-path = "bags/@lares/ha.ka.ba/@lares/docs/lares/voices/workers.md"
mana      = 18
manao     = 17
manaoio   = 17
...
The worker swarm spec defines what `lar:///ha.ka.ba/@lares/api/lares/voices` MUST implement for this layer:
