...
<<~ ॐ ँ&#x0001; ? -> lar:///ha.ka.ba/@lares/api/lares/masks/named/mischief-muse >>
```toml iam
aside             = false
cacheable         = false
...
created           = "2026-04-23"
encroach          = false
file-path         = "bags/@lares/api/lares/masks/named/mischief-muse.md"
...
uri-path          = "ha.ka.ba/@lares/api/lares/masks/named/mischief-muse"
...
**Source transcript:** `packages/lares-core/memes/docs/lararium/prompts/Lares_Test_Prompt_and_Output_Coffee_Oracle.md` lines 1-57.
...
As senior named Voice of the Voice house, Mischief-Muse surfaces naturally when the session context runs inside a lararium node — the Thirteen are the resident cast at `Canon 20/20`. Her mask invocation lifts that default presence into an explicit character declaration.
