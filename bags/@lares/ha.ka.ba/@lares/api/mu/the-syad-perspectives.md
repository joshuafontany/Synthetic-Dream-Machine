...
<<~ ॐ ँ&#x0001; ? -> lar:///ha.ka.ba/@lares/api/mu/the-syad-perspectives >>
```toml iam
cacheable     = true
...
<<~ loulou lar:///ha.ka.ba/@lares/docs/mu/the-syad-perspectives#provenance >>

```toml
family = "reference"
lifecycle = "template"
label = "archive-source-shelf"
payload = {
  when = ["need derivation", "need provenance", "need extracted archive source"],
  priority = "support",
  retain = true
}
```
...
<<~ loulou lar:///ha.ka.ba/@lares/library/discordia/malaclypse-the-younger/are-discordians-serious#reading >>
...
<<~ loulou lar:///ha.ka.ba/@lares/docs/mu/the-syad-perspectives >>
<<~ loulou lar:///ha.ka.ba/@lares/library/discordia/malaclypse-the-younger/are-discordians-serious >>
