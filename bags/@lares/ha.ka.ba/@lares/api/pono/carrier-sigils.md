...
<<~ ⊙&#x0001; ? -> lar:///ha.ka.ba/@lares/api/pono/carrier-sigils >>
```toml iam
cacheable   = true
...
```
<<~ ⊙&#x0001; ? -> lar:///ha.ka.ba/@lares/api/pono/… >>      ← pono layer
<<~ ॐ ँ&#x0001; ? -> lar:///ha.ka.ba/@lares/api/lares/… >>   ← mu/lares/lararium layer
<<~ &#x0001; ? -> lar:///ha.ka.ba/@lares/docs/… >>          ← docs/library, bare
```
