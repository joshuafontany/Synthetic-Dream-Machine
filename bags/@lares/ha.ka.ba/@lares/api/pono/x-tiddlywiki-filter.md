...
```toml iam
cacheable   = true
file-path   = "bags/@lares/api/pono/x-tiddlywiki-filter.md"
...
`wikitext-filter` (`lar:///ha.ka.ba/@lares/api/pono/wikitext-filter`)
...
See the full spec: `lar:///ha.ka.ba/@lares/api/pono/wikitext-filter`
...
<<~ loulou lar:///ha.ka.ba/@lares/api/pono/wikitext-filter >>
