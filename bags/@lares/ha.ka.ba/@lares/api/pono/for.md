...
<<~ ⊙&#x0001; ? -> lar:///ha.ka.ba/@lares/api/pono/for >>
```toml iam
cacheable = true
file-path = "bags/@lares/api/pono/for.md"
mana      = 18
manao     = 17
manaoio   = 17
namespace = "&#x2299;"
...
uri-path  = "ha.ka.ba/@lares/api/pono/for"
```
...
English alias for `huli`. See canonical spec:

<<~ aka lar:///ha.ka.ba/@lares/api/pono/huli >>
