...
<<~ ⊙&#x0001; ? -> lar:///ha.ka.ba/@lares/api/pono/papalohe >>
```toml iam
cacheable = true
file-path = "bags/@lares/api/pono/papalohe.md"
mana      = 17
manao     = 17
manaoio   = 16
namespace = "&#x2299;"
...
tags      = ["api/pono/pranala", "api/pono/reaction-graph", "lar:///ha.ka.ba/@lararium/tw5/tiddlers/sigil-papalohe"]
type      = "text/x-memetic-wikitext"
uri-path  = "ha.ka.ba/@lares/api/pono/papalohe"
```
