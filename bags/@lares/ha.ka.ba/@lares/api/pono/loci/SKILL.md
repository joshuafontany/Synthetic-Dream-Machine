---
name: loci
description: "Perform, audit, or repair a loci routing-and-rating pass under lar:///ha.ka.ba/@lares/api/pono/loci. Use this skill for URI intake, derivation algorithm execution, resolution posture commitment, canon-MOVE evaluation, file-path migration, or routing aftermath judgment."
allowed-tools: Read, Grep, Glob, Bash, Edit, Write
---
<!-- <<~ !DOCTYPE = lar:///ha.ka.ba/@lares/api/pono/memetic-wikitext >> -->

<<~ &#x0001; ? -> lar:///ha.ka.ba/@lares/api/pono/loci/SKILL >>
```toml iam
...
covers             = ["lar:///ha.ka.ba/@lares/api/pono/loci"]
file-path          = "bags/@lares/api/pono/loci/SKILL.md"
mana               = 14
manao              = 16
manaoio            = 13
...
- MCP server design or live-resolver research → `lar:///ha.ka.ba/@lares/api/pono/loci/iam`
- generic meme law → `lar:///ha.ka.ba/@lares/api/pono/meme`
- invariant compression or sidecar splitting → `lar:///ha.ka.ba/@lares/api/pono/cache-stable/SKILL`
...
- canon-lifecycle: a carrier may not self-MOVE to canon; all conditions in `lar:///ha.ka.ba/@lares/api/pono/loci/iam` MUST hold
