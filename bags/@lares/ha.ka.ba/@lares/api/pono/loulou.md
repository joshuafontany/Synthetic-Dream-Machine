...
<<~ ⊙&#x0001; ? -> lar:///ha.ka.ba/@lares/api/pono/loulou >>
```toml iam
cacheable = true
file-path = "bags/@lares/api/pono/loulou.md"
mana      = 17
manao     = 17
manaoio   = 16
namespace = "&#x2299;"
...
uri-path  = "ha.ka.ba/@lares/api/pono/loulou"
```
...
<<~ loulou lar:///ha.ka.ba/@lares/api/pono/meme#law >>
```
