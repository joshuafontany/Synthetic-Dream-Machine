...
<<~ ⊙&#x0001; ? -> lar:///ha.ka.ba/@lares/api/pono/pono-sigil >>
```toml iam
cacheable = true
file-path = "bags/@lares/api/pono/pono-sigil.md"
namespace = "&#x2299;"
register  = "Synthesis"
retain    = true
...
uri-path  = "ha.ka.ba/@lares/api/pono/pono-sigil"
```
...
the same word because a `pono` edge asserts alignment — the naming runs intentional.
