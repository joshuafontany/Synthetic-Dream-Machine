---
name: lar-uri
description: Author, validate, or audit lar: URI addresses under lar:///ha.ka.ba/@lares/api/pono/lar-uri. Keep the scheme law small, hold the path taxonomy and the one-bag @-rule distinct, and resolve names against the local graph — never as a network fetch.
...
covers             = ["lar:///ha.ka.ba/@lares/api/pono/lar-uri"]
file-path          = "bags/@lares/api/pono/lar-uri/SKILL.md"
mana               = 15
manao              = 16
manaoio            = 14
