...
<<~ ⊙&#x0001; ? -> lar:///ha.ka.ba/@lares/api/pono/conformance >>
```toml iam
cacheable = true
file-path = "bags/@lares/api/pono/conformance.md"
mana      = 12
manao     = 13
manaoio   = 12
namespace = "&#x2299;"
...
uri-path  = "ha.ka.ba/@lares/api/pono/conformance"
```
