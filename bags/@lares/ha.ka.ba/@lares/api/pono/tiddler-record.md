...
<<~ ⊙&#x0001; ? -> lar:///ha.ka.ba/@lares/api/pono/tiddler-record >>
```toml iam
cacheable     = true
file-path     = "bags/@lares/api/pono/tiddler-record.md"
l-space       = "stable"
mana          = 18
manao         = 18
manaoio       = 18
...
uri-path      = "ha.ka.ba/@lares/api/pono/tiddler-record"
```
...
<<~ loulou lar:///ha.ka.ba/@lararium/tw5/schema/projection-codec >>
<<~ loulou lar:///ha.ka.ba/@lararium/tw5/modules/sync-adaptor >>
