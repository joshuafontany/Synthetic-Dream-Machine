...
<<~ ⊙&#x0001; ? -> lar:///ha.ka.ba/@lares/api/pono/verse-type-lattice >>
```toml iam
cacheable   = true
file-path   = "bags/@lares/api/pono/verse-type-lattice.md"
l-space     = "stable"
mana        = 17
manao       = 17
namespace   = "&#x2299;"
...
uri-path    = "ha.ka.ba/@lares/api/pono/verse-type-lattice"
```
...
<<~ loulou lar:///ha.ka.ba/@lares/api/pono/verse-task-tree >>
...
<<~ loulou lar:///ha.ka.ba/@lares/api/pono/pono >>
