...
<<~ ⊙&#x0001; ? -> lar:///ha.ka.ba/@lares/api/pono/uefn-scene >>
```toml iam
cacheable = true
file-path = "bags/@lares/api/pono/uefn-scene.md"
namespace = "&#x2299;"
register  = "Synthesis"
retain    = true
role      = "UEFN scene decomposition model — Verse scene file → Lararium wiki graph → TW5 filtered views; web3 / NOT Blueprint"
tags      = ["lar:///ha.ka.ba/@lararium/mesh/kumu-device"]
type      = "text/x-memetic-wikitext"
uri-path  = "ha.ka.ba/@lares/api/pono/uefn-scene"
```
