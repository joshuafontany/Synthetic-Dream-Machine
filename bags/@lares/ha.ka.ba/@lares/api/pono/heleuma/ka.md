...
<<~ ⊙&#x0001; ? -> lar:///ha.ka.ba/@lares/api/pono/heleuma/ka >>
```toml iam
cacheable = true
file-path = "bags/@lares/api/pono/heleuma/ka.md"
mana      = 18
manao     = 17
manaoio   = 17
namespace = "&#x2299;"
...
uri-path  = "ha.ka.ba/@lares/api/pono/heleuma/ka"
```
...
<<~ loulou lar:///ha.ka.ba/@lares/api/lararium/modules/boot-gate >>
