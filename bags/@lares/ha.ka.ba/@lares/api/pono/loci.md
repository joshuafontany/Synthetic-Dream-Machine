...
<<~ ⊙&#x0001; ? -> lar:///ha.ka.ba/@lares/api/pono/loci >>
```toml iam
cacheable = true
file-path = "bags/@lares/api/pono/loci.md"
mana      = 15
manao     = 17
manaoio   = 13
namespace = "&#x2299;"
...
uri-path  = "ha.ka.ba/@lares/api/pono/loci"
```
...
<<~ loulou lar:///ha.ka.ba/@lares/api/pono/loci/SKILL >>
...
<<~ loulou lar:///ha.ka.ba/@lares/api/pono/loci/iam >>
...
1. Validate l-space eligibility:
     ...
     sub-path = match[2]   e.g. "@lares/api/pono/loci"
...
2. Derive candidate filepath (holding-bag REQUIRED — siting = f(bag, uri)):
     candidate = "bags/" + <holding-bag-scope> + "/" + root + "/" + sub-path + ".md"
       e.g. (@lares, …api/pono/loci) → "bags/@lares/ha.ka.ba/@lares/api/pono/loci.md"
       e.g. (@draft, same name)      → "bags/@draft/ha.ka.ba/@lares/api/pono/loci.md"
...
`lar:///ha.ka.ba/@lares/api/pono/cache-stable/SKILL` → `bags/@lares/ha.ka.ba/@lares/api/pono/cache-stable/SKILL.md`
...
|---|---|---|
| primary meme | derivation algorithm (step 2) | `bags/@lares/ha.ka.ba/@lares/api/pono/loci.md` |
| child item | sibling directory named for parent's terminal path segment | `bags/@lares/ha.ka.ba/@lares/api/pono/loci/iam.md` |
...
|---|---|---|
| (@lares, `lar:///ha.ka.ba/@lares/api/pono/loci`) | `bags/@lares/ha.ka.ba/@lares/api/pono/loci.md` | canon |
| (@draft, the same name) | `bags/@draft/ha.ka.ba/@lares/api/pono/loci.md` | residency-true |
| (@sdm, `lar:///ha.ka.ba/@sdm/components/posture/ritual`) | `bags/@sdm/ha.ka.ba/@sdm/components/posture/ritual.md` | canon |
...
4. canon-MOVE criteria (`lar:///ha.ka.ba/@lares/api/pono/loci/iam`)
