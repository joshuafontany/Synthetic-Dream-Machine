...
<<~ ⊙&#x0001; ? -> lar:///ha.ka.ba/@lares/api/pono/tick >>
```toml iam
cacheable = true
file-path = "bags/@lares/api/pono/tick.md"
namespace = "&#x2299;"
register  = "Synthesis"
retain    = true
...
uri-path  = "ha.ka.ba/@lares/api/pono/tick"
```
...
Device lifecycle hook: run this block once per *nalu* (simulation tick / refresh wave).
