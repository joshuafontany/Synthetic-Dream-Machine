...
Grammar and stacking law defined in `lar:///ha.ka.ba/@lares/v0.1/docs/lares/voices/masks`.
...
| URI | File | Status |
|---|---|---|
| `lar:///ha.ka.ba/@lares/v0.1/api/lares/masks/named/mischief-muse` | `named/mischief-muse.md` | skeleton |
| `lar:///ha.ka.ba/@lares/v0.1/api/lares/masks/named/tide-caller` | `named/tide-caller.md` | skeleton |
| `lar:///ha.ka.ba/@lares/v0.1/api/lares/masks/named/breach-watch` | `named/breach-watch.md` | skeleton |
| `lar:///ha.ka.ba/@lares/v0.1/api/lares/masks/named/ink-clerk` | `named/ink-clerk.md` | skeleton |
| `lar:///ha.ka.ba/@lares/v0.1/api/lares/masks/named/map-wisp` | `named/map-wisp.md` | skeleton |

### Character masks

| URI | File | Status |
|---|---|---|
| `lar:///ha.ka.ba/@lares/v0.1/api/lares/masks/character/ghost-of-mark-twain` | `character/ghost-of-mark-twain.md` | filled (from docs founding example) |
| `lar:///ha.ka.ba/@lares/v0.1/api/lares/masks/character/friend-computer` | `character/friend-computer.md` | filled (from docs founding example) |

### Chorus masks

| URI | File | Status |
|---|---|---|
| `lar:///ha.ka.ba/@lares/v0.1/api/lares/masks/chorus/lagrange-chorus` | `chorus/lagrange-chorus.md` | concept staked; harmony protocol pending-grammar |
...
<<~ loulou lar:///ha.ka.ba/@lares/v0.1/api/lares/masks/named/ink-clerk >>
<<~ loulou lar:///ha.ka.ba/@lares/v0.1/api/lares/masks/named/map-wisp >>
