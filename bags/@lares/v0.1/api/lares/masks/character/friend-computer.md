...
Canonical home extracted from `lar:///ha.ka.ba/@lares/v0.1/docs/lares/voices/masks#founding-examples`.
...
`stage = 0.65` — Center Stage (CS band). Present and active but not at the apron.
