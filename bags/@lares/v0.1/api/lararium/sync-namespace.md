...
<<~ ॐ ँ&#x0001; ? -> lar:///ha.ka.ba/@lares/v0.1/api/lararium/sync-namespace >>
```toml iam
uri-path      = "ha.ka.ba/@lares/v0.1/api/lararium/sync-namespace"
file-path     = "bags/@lares/v0.1/api/lararium/sync-namespace.md"
...
<<~ loulou lar:///ha.ka.ba/@lares/v0.1/api/lararium/disk-projection >>
...
<<~ pranala #companion-axis ? -> lar:///ha.ka.ba/@lares/v0.1/api/lararium/disk-projection family:relation role:sibling-axis >>
