...
A pranala edge MUST declare a **family** from the canonical set. Families carry role vocabularies and contract flags; the canonical taxonomy lives at `lar:///ha.ka.ba/@lares/v0.1/api/pono/pranala-families`. The families align to the two render surfaces:
