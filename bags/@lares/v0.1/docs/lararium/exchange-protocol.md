...
- The sigils carry humility instruments, not decorative badges:
  ...
  - `hud Aperture(N)` (0–20) — attention range, the grain/zoom the span carries; bands Pulse·Beat·Measure·Arc·Theme. Primary signal during `--parse` intake. See `lar:///ha.ka.ba/@lares/v0.1/api/pono/attention-scale`.
