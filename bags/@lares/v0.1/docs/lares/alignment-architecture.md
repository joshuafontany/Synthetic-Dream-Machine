...
- **Session Wiki** = the coordinator `lar_playspace`: broadest recipe, owns the session event-bus bag, pinned-wela. Coordinates N other `lar_playspace` wikis in the session.
