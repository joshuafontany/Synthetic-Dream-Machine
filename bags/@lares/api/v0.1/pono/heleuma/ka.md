...
<<~⊙&#x0001; ? -> lar:///ha.ka.ba/@lares/api/v0.1/pono/heleuma/ka >>
```toml iam
uri-path = "ha.ka.ba/@lares/api/v0.1/pono/heleuma/ka"
file-path = "bags/@lares/api/v0.1/pono/heleuma/ka.md"
...
<<~ pranala #gate ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/modules/boot-gate family:control role:promoted-by >>
