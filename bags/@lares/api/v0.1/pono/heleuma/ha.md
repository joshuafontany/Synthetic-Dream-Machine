...
<<~⊙&#x0001; ? -> lar:///ha.ka.ba/@lares/api/v0.1/pono/heleuma/ha >>
```toml iam
uri-path = "ha.ka.ba/@lares/api/v0.1/pono/heleuma/ha"
file-path = "bags/@lares/api/v0.1/pono/heleuma/ha.md"
...
A heleuma-ha anchor exists outside the `lar:///` corpus **by nature, not by stage**. It defines territory that the runtime inhabits. It does not promote.
