...
<<~&#x0001; ? -> lar:///ha.ka.ba/@sdm/v0.0/witness/powers/handoff-archive >>
```toml iam
uri-path  = "ha.ka.ba/@sdm/v0.0/witness/powers/handoff-archive"
file-path = "bags/@sdm/v0.0/witness/powers/handoff-archive.md"
...
The ontology root now lives at `lar:///ha.ka.ba/@sdm/v0.0/api/power`. The meme-set shape (api root → interface → projection → witness) now carries canon status in the template tree.
...
| File | Status |
|---|---|
| `bags/@sdm/v0.0/templates/api/power.md` | ✓ exists |
| `bags/@sdm/v0.0/templates/projections/powers/ftls-card.md` | ✓ exists |
| `bags/@sdm/v0.0/templates/witness/powers/osr-spells.md` | ✓ exists |
| `bags/@sdm/v0.0/api/powers/read-magic.md` | ✓ exists |
| `bags/@sdm/v0.0/projections/powers/ftls-card/read-magic.md` | ✓ exists |
| `bags/@sdm/v0.0/witness/powers/osr-spells/read-magic.md` | ✓ exists |

Floating Disc and Shield Ward followed read-magic as additional proofs (not in original First Task scope).

The ontology root `bags/@sdm/v0.0/api/power.md` landed post-handoff via session work. The ha.ka.ba activation address schema, storage taxonomy, and overcharge model now live there.
...
```text
bags/@sdm/v0.0/interfaces/powers/ecm-scan.md
bags/@sdm/v0.0/interfaces/powers/magic-decode.md
bags/@sdm/v0.0/interfaces/powers/archive-recognition.md
```
...
```text
bags/@sdm/v0.0/api/modules/knowledge-oracle.md
```
...
```text
bags/@sdm/v0.0/api/tags/power.md
bags/@sdm/v0.0/api/tags/ecm-scan.md
bags/@sdm/v0.0/api/tags/storage-trait.md
bags/@sdm/v0.0/api/tags/storage-item.md
bags/@sdm/v0.0/api/tags/storage-structure.md
bags/@sdm/v0.0/api/tags/storage-burden.md
```
...
- Version sits directly under the bag member: `@sdm/v0.0/api/...`
...
<<~ pranala #provenance ? -> lar:///ha.ka.ba/@sdm/v0.0/api/power family:provenance role:witness >>
