...
<<~&#x0001; ? -> lar:///ha.ka.ba/@sdm/v0.0/interfaces/powers/floating-disc >>
```toml iam
uri-path  = "ha.ka.ba/@sdm/v0.0/interfaces/powers/floating-disc"
file-path = "bags/@sdm/v0.0/interfaces/powers/floating-disc.md"
...
filters = ["edge:control:implements[lar:///ha.ka.ba/@sdm/v0.0/interfaces/power] tag:@sdm[domain/stuckforce]", "power:operation[create-stuckforce-platform]"]
...
<<~ pranala #implemented-by ? -> lar:///ha.ka.ba/@sdm/v0.0/api/powers/floating-disc family:control role:implemented-by >>
