...
<<~&#x0001; ? -> lar:///ha.ka.ba/@sdm/v0.0/interfaces/power >>
```toml iam
uri-path  = "ha.ka.ba/@sdm/v0.0/interfaces/power"
file-path = "bags/@sdm/v0.0/interfaces/power.md"
...
filters = ["edge:control:implements[lar:///ha.ka.ba/@sdm/v0.0/interfaces/power]", "power:operation[express-and-pay-noospheric-force]"]
...
Discovery via graph traversal: `edge:control:implements[lar:///ha.ka.ba/@sdm/v0.0/interfaces/power]`
Concrete interfaces self-declare upward with `family:control role:implements` — no enumeration here.

<<~ pranala #ontology-root ? -> lar:///ha.ka.ba/@sdm/v0.0/api/power family:reference role:see >>
