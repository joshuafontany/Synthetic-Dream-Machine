...
<<~&#x0001; ? -> lar:///ha.ka.ba/@sdm/v0.0/api/powers/read-magic >>
```toml iam
uri-path  = "ha.ka.ba/@sdm/v0.0/api/powers/read-magic"
file-path = "bags/@sdm/v0.0/api/powers/read-magic.md"
...
<<~ loulou lar:///ha.ka.ba/@sdm/v0.0/interfaces/powers/read-magic >>

<<~ pranala #implements ? -> lar:///ha.ka.ba/@sdm/v0.0/interfaces/power family:control role:implements >>
<<~ pranala #implements ? -> lar:///ha.ka.ba/@sdm/v0.0/interfaces/powers/read-magic family:control role:implements >>
<<~/ahu >>
...
duration = "10 minutes"
module = "lar:///ha.ka.ba/@sdm/v0.0/api/modules/knowledge-oracle"
```
...
<<~ loulou lar:///ha.ka.ba/@sdm/v0.0/projections/powers/ftls-card/read-magic >>
<<~ loulou lar:///ha.ka.ba/@sdm/v0.0/witness/powers/osr-spells/read-magic >>
...
<<~ pranala #projects ? -> lar:///ha.ka.ba/@sdm/v0.0/projections/powers/ftls-card/read-magic family:render role:projects >>
<<~ pranala #witness ? -> lar:///ha.ka.ba/@sdm/v0.0/witness/powers/osr-spells/read-magic family:provenance role:witness >>
<<~ pranala #module ? -> lar:///ha.ka.ba/@sdm/v0.0/api/modules/knowledge-oracle family:taxonomy role:belongs >>
