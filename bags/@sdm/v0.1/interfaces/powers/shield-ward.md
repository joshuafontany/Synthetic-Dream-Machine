...
<<~&#x0001; ? -> lar:///ha.ka.ba/@sdm/v0.1/interfaces/powers/shield-ward >>
```toml iam
uri-path  = "ha.ka.ba/@sdm/v0.1/interfaces/powers/shield-ward"
file-path = "bags/@sdm/v0.1/interfaces/powers/shield-ward.md"
...
filters = ["edge:control:implements[lar:///ha.ka.ba/@sdm/v0.1/interfaces/power] tag:@sdm[function/ward]", "power:operation[raise-personal-ward]"]
...
<<~ pranala #implemented-by ? -> lar:///ha.ka.ba/@sdm/v0.1/api/powers/shield-ward family:control role:implemented-by >>
