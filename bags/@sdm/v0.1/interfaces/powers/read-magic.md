...
<<~&#x0001; ? -> lar:///ha.ka.ba/@sdm/v0.1/interfaces/powers/read-magic >>
```toml iam
uri-path  = "ha.ka.ba/@sdm/v0.1/interfaces/powers/read-magic"
file-path = "bags/@sdm/v0.1/interfaces/powers/read-magic.md"
...
filters = ["edge:control:implements[lar:///ha.ka.ba/@sdm/v0.1/interfaces/power] tag:@sdm[domain/divination]", "power:operation[decode-magical-inscription]"]
...
<<~ pranala #implemented-by ? -> lar:///ha.ka.ba/@sdm/v0.1/api/powers/read-magic family:control role:implemented-by >>
