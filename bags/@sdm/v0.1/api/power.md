...
<<~&#x0001; ? -> lar:///ha.ka.ba/@sdm/v0.1/api/power >>
```toml iam
uri-path  = "ha.ka.ba/@sdm/v0.1/api/power"
file-path = "bags/@sdm/v0.1/api/power.md"
...
Each Power already carries a stable tagspace address at `lar:///ha.ka.ba/@sdm/v0.1/api/powers/**`. That address serves as the entry, tracking, and query node — no additional activation URI schema needs to land on individual Power memes.

When a session or routing context needs a **hostful or hostless activation URI** for a live Power crossing event, generate it against the ha.ka.ba three-slot grammar. Full guidance and rationale live at `lar:///ha.ka.ba/@sdm/v0.1/docs/power-ontology`. Apply that guidance in context; do not bake it into Power memes or templates.
...
<<~ loulou lar:///ha.ka.ba/@sdm/v0.1/api/powers/floating-disc >>
<<~ loulou lar:///ha.ka.ba/@sdm/v0.1/api/powers/shield-ward >>

<<~ pranala #implements ? -> lar:///ha.ka.ba/@lares/v0.1/api/pono/meme family:control role:implements >>
<<~ pranala #implements-invariant ? -> lar:///ha.ka.ba/@lares/v0.1/api/pono/invariant family:control role:implements >>
<<~ pranala #docs ? -> lar:///ha.ka.ba/@sdm/v0.1/docs/power-ontology family:reference role:expands >>
