...
<<~&#x0001; ? -> lar:///ha.ka.ba/@sdm/v0.1/templates/api/power >>
```toml iam
uri-path  = "ha.ka.ba/@sdm/v0.1/templates/api/power"
file-path = "bags/@sdm/v0.1/templates/api/power.md"
...
<<~ pranala #see ? -> lar:///ha.ka.ba/@sdm/v0.1/templates/interfaces/power family:template role:see >>
