...
<<~ &#x0001; ? -> lar:///ha.ka.ba/@sdm/components/hook/attack >>
```toml iam
cacheable = true
caption   = "attack"
file-path = "bags/@sdm/ha.ka.ba/@sdm/components/hook/attack.md"
mana      = 14
manao     = 16
manaoio   = 13
register  = "Synthesis"
...
uri-path  = "ha.ka.ba/@sdm/components/hook/attack"
```
...
```text
[tag[lar:///ha.ka.ba/@sdm/components/hook/attack]]                    all attack modules
