...
<<~ &#x0001; ? -> lar:///ha.ka.ba/@sdm/projections/powers/ftls-card/shield-ward >>
```toml iam
cacheable = true
file-path = "bags/@sdm/ha.ka.ba/@sdm/projections/powers/ftls-card/shield-ward.md"
mana      = 14
manao     = 17
manaoio   = 15
...
uri-path  = "ha.ka.ba/@sdm/projections/powers/ftls-card/shield-ward"
```
