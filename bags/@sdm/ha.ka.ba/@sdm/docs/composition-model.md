...
<<~ &#x0001; ? -> lar:///ha.ka.ba/@sdm/docs/composition-model >>
```toml iam
cacheable = true
file-path = "bags/@sdm/ha.ka.ba/@sdm/docs/composition-model.md"
mana      = 15
manao     = 18
manaoio   = 14
register  = "Synthesis"
...
uri-path  = "ha.ka.ba/@sdm/docs/composition-model"
```
...
- **Pattern (stable).** The Pranala `#has` graph + module/component/mount-point memes. What *Read Magic consists of*. Lives in `bags/@sdm/**` as memetic-wikitext.
...
traits:
  - uri: lar:///ha.ka.ba/@sdm/modules/powers/read-magic
    ...
    locks: null
sites:
  - uri: lar:///ha.ka.ba/@sdm/modules/sites/lindwyrm
    mount: structure
...
**Location merges into Structure.** A forest and an airship are the same Site. **Fixed-vs-mobile is a flat `#has` component** (propulsion/mobility), not a mount-point or a type. A Site gains capacity by spending XP + referee resources per attribute, decoupled from Level (OGA "Golden Age Item Upgrading"). See `lar:///ha.ka.ba/@sdm/mount-points/structure`.
...
<<~ loulou lar:///ha.ka.ba/@sdm/epic/powers-composition-rewrite >>
<<~ loulou lar:///ha.ka.ba/@sdm/templates/modules/power >>
<<~ loulou lar:///ha.ka.ba/@sdm/mount-points/structure >>
