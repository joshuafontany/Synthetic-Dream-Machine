...
<<~ &#x0001; ? -> lar:///ha.ka.ba/@sdm/witness/items/uvg/porters-pebble >>
```toml iam
cacheable = true
file-path = "bags/@sdm/ha.ka.ba/@sdm/witness/items/uvg/porters-pebble.md"
mana      = 11
manao     = 16
manaoio   = 15
...
uri-path  = "ha.ka.ba/@sdm/witness/items/uvg/porters-pebble"
```
...
```toml witness
artifact-class = "pebble-machine relic (Long Ago make)"
holds = "Floating Disc"
book = "Ultraviolet Grasslands and the Black City 2e"
basis = "Floating Disc module, 'Stuckforce Relic' variant — 'a found disc or pebble-machine holds position until pushed; seats item'"
```
