...
<<~ &#x0001; ? -> lar:///ha.ka.ba/@sdm/witness/powers/osr-spells/shield-ward >>
```toml iam
cacheable = true
file-path = "bags/@sdm/ha.ka.ba/@sdm/witness/powers/osr-spells/shield-ward.md"
mana      = 12
manao     = 16
manaoio   = 17
...
uri-path  = "ha.ka.ba/@sdm/witness/powers/osr-spells/shield-ward"
```
...
- `Range: 0`, self-only, inch-close, body-following → a skin-close force shell, not carried gear. Carries `function/ward` (selective) over `function/barrier` (the shell itself).
...
<<~ loulou lar:///ha.ka.ba/@sdm/templates/witness/powers/osr-spells >>
<<~ loulou lar:///ha.ka.ba/@sdm/modules/powers/shield-ward >>
<<~ loulou lar:///ha.ka.ba/@sdm/source/becmi/basic >>
<<~ loulou lar:///ha.ka.ba/@sdm/source/becmi/rules-cyclopedia >>
