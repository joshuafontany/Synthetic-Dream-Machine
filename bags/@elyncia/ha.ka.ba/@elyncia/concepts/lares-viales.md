...
<<~ &#x0001; ? -> lar:///ha.ka.ba/@elyncia/concepts/lares-viales >>
```toml iam
cacheable = true
file-path = "bags/@elyncia/concepts/lares-viales.md"
mana      = 14
manao     = 14
manaoio   = 13
register  = "Synthesis"
retain    = true
role      = "the Lares Viales / Hermai — wayfarer-lares and crossroads-markers of the leylines; the fiction of the minimal blind-carriage node (cap-model at @lararium/mesh/vessel-caps#lares-viales)"
l-space   = "stable:@elyncia"
type      = "text/x-memetic-wikitext"
uri-path  = "ha.ka.ba/@elyncia/concepts/lares-viales"
```

<<~ &#x0002; >>

# Lares Viales ~ the Wayfarers of the Leylines
