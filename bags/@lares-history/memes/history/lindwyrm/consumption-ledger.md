...
This ledger tracks source-talk-story material as it moves into coherent narrative loci under `lar:///ha.ka.ba/@lares/docs/story/lindwyrm`.
...
<<~ pranala #fourth-consumption ? -> lar:///ha.ka.ba/@lares/docs/story/lindwyrm/self-booting-lararium family:reference role:records >>
<<~ pranala #fifth-consumption ? -> lar:///ha.ka.ba/@lares/docs/story/lindwyrm/hoard-origin-architecture family:reference role:records >>
<<~ pranala #sixth-consumption ? -> lar:///ha.ka.ba/@lares/docs/story/lindwyrm/dreamdeck-feed-architecture family:reference role:records >>
<<~ pranala #act-i-draft ? -> lar:///ha.ka.ba/@lares/docs/story/lindwyrm/vault-and-repo family:reference role:records >>
