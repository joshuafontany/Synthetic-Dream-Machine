...
<<~&#x0001; ? -> lar:///ha.ka.ba/@lararium/browser/v0.1/full-detached-worker-authority-pool-sprint >>
```toml iam
uri-path     = "ha.ka.ba/@lararium/browser/v0.1/full-detached-worker-authority-pool-sprint"
file-path    = "bags/@lararium/browser/v0.1/full-detached-worker-authority-pool-sprint.md"
