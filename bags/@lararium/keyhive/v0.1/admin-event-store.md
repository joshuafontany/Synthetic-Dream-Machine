...
<<~&#x0001; ? -> lar:///ha.ka.ba/@lararium/keyhive/v0.1/admin-event-store >>
```toml iam
uri-path     = "ha.ka.ba/@lararium/keyhive/v0.1/admin-event-store"
file-path    = "bags/@lararium/keyhive/v0.1/admin-event-store.md"
