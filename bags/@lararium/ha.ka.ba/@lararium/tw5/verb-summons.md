...
<<~ &#x0001; ? -> lar:///ha.ka.ba/@lararium/tw5/verb-summons >>
```toml iam
cacheable   = true
...
Naming note: "signal" names a DIFFERENT layer — the Agent↔Operator HUD/legibility frame (`lar:///ha.ka.ba/@lararium/docs/signal`). The task-transport noun reads **summons** (renamed from "signal" 2026-06-07 by research verdict — grammar register, no compute-runtime freight). The fuller surface + the UCAN boundary projection live in [lar:///ha.ka.ba/@lararium/mesh/verb-tiddler](../mesh/verb-tiddler.md).
