...
<<~ &#x0001; ? -> lar:///ha.ka.ba/@lararium/tw5/ui/iam-panel >>
```toml iam
cacheable = true
file-path = "bags/@lararium/tw5/ui/iam-panel.md"
mana      = 18
manao     = 18
manaoio   = 17
...
tags      = ["$:/tags/Global", "lar:///ha.ka.ba/@lares/api/pono/meme"]
type      = "text/x-memetic-wikitext"
uri-path  = "ha.ka.ba/@lararium/tw5/ui/iam-panel"
```
...
tier2 = ["role", "namespace", "register", "l-space"]
...
<$list filter="role namespace register l-space" variable="f">
<$set name="v" value={{{ [{!!$(f)$}] }}}>
<$reveal type="nomatch" state="" text="">
