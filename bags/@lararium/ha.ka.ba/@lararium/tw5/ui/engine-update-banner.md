...
<<~ &#x0001; ? -> lar:///ha.ka.ba/@lararium/tw5/ui/engine-update-banner >>
```toml iam
cacheable = true
file-path = "bags/@lararium/tw5/ui/engine-update-banner.md"
mana      = 18
manao     = 17
manaoio   = 16
...
uri-path  = "ha.ka.ba/@lararium/tw5/ui/engine-update-banner"
```
