...
<<~ ॐ ँ&#x0001; ? -> lar:///ha.ka.ba/@lararium/mesh/reaction-engine >>
```toml iam
cacheable   = true
...
Layer 3 — nalu (the wave)
  ...
  See: lar:///ha.ka.ba/@lares/api/pono/nalu
...
Layer 5 — IslandMsg_Event / CRDT convergence (the crossing)
  ...
  See: lar:///ha.ka.ba/@lararium/mesh/island-protocol
```
...
Within-island dispatch (ReactionGraph):
  ...
  See: lar:///ha.ka.ba/@lararium/mesh/reaction-graph
...
<<~ loulou lar:///ha.ka.ba/@lararium/mesh/kumu-device >>
