...
Live HUD contract text stays in `lar:///ha.ka.ba/@lararium/v0.1/docs/signal/hud`.
Theory-facing framing stays in `lar:///ha.ka.ba/@lararium/v0.1/docs/signal/sa-display`.
