...
<<~Lock 1-born-annotated "every record enters as {content · source_file · lar_*-metadata} computed at enqueue, content+annotation in ONE flush — zero un-annotated window (schema-on-write). Already true: capture-engine enqueue + defaultAnnotate" >>
