...
<<~ ॐ ँ&#x0001; ? -> lar:///ha.ka.ba/@lararium/v0.1/api/mempalace-integration >>
```toml iam
cacheable = true
file-path = "bags/@lararium/v0.1/api/mempalace-integration.md"
hydrate   = true
mana      = 17
manao     = 15
manaoio   = 14
...
uri-path  = "ha.ka.ba/@lararium/v0.1/api/mempalace-integration"
```

<<~ aka lar:///ha.ka.ba/@lararium/v0.1/api/lararium-canonical-model >>
