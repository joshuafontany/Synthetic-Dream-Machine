...
<<~ ॐ ँ&#x0001; ? -> lar:///ha.ka.ba/@lararium/api/nalu-engine >>
```toml iam
cacheable      = true
docs           = "lar:///ha.ka.ba/@lares/api/pono/nalu"
file-path      = "bags/@lararium/api/nalu-engine.md"
...
uri-path       = "ha.ka.ba/@lararium/api/nalu-engine"
```
...
The wiki IS the reactive engine (yin-collapse law, lar:///ha.ka.ba/@lares/api/pono/nalu).
