...
```toml iam
cacheable = false
file-path = "bags/@lararium/docs/signal/sa-display.md"
mana      = 16
manao     = 17
manaoio   = 16
register  = "Synthesis"
...
uri-path  = "ha.ka.ba/@lararium/docs/signal/sa-display"
```
...
Branch contract stays at `lar:///ha.ka.ba/@lararium/docs/signal`.
HUD witness and annotation behavior stay at `lar:///ha.ka.ba/@lararium/docs/signal/hud`.
