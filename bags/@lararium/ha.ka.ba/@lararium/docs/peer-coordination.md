...
<<~ &#x0001; ? -> lar:///ha.ka.ba/@lararium/docs/peer-coordination >>
```toml iam
cacheable = true
file-path = "bags/@lararium/docs/peer-coordination.md"
mana      = 18
manao     = 18
manaoio   = 17
...
tags      = ["lar:///ha.ka.ba/@lares/api/pono/meme", "lar:///ha.ka.ba/@lares/api/pono/local-first"]
type      = "text/x-memetic-wikitext"
uri-path  = "ha.ka.ba/@lararium/docs/peer-coordination"
```
