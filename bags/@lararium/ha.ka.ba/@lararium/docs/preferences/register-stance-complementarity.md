...
```toml iam
cacheable = false
file-path = "bags/@lararium/docs/preferences/register-stance-complementarity.md"
l-space   = "stable"
mana      = 16
manao     = 17
manaoio   = 17
...
uri-path  = "ha.ka.ba/@lararium/docs/preferences/register-stance-complementarity"
```
...
**Resolved 2026-06-05:** the coupling now rides Canon as **lens-gated** --- a stance re-declares a confidence number's measure only when the `syad` lens runs; absent invocation, confidence reads its default frame. The naya↔predication relationship supersedes the old "mapping" framing. Canon: `lar:///ha.ka.ba/@lares/api/mu/the-syad-perspectives`. This shelf stays as staging history.
...
<<~ loulou lar:///ha.ka.ba/@lararium/docs/preferences/epistemology >>
