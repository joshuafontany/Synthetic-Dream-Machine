...
```toml iam
cacheable = false
file-path = "bags/@lararium/docs/preferences/identity-permissions.md"
l-space   = "stable"
mana      = 18
manao     = 17
manaoio   = 17
...
uri-path  = "ha.ka.ba/@lararium/docs/preferences/identity-permissions"
```
...
- `lar:///ha.ka.ba/@lararium/tw5/continuity`
- `lar:///LARES`
