...
<<~ &#x0001; ? -> lar:///ha.ka.ba/@lararium/docs/tw5-boot-gate >>
```toml iam
file-path   = "bags/@lararium/docs/tw5-boot-gate.md"
mana        = 17
manao       = 17
manaoio     = 17
...
uri-path    = "ha.ka.ba/@lararium/docs/tw5-boot-gate"
```
...
The **implementors interface** it queries IS a meme: `lar:///ha.ka.ba/@lares/api/lararium/modules/tw5-module-interface`. Any meme that declares `implements = "lar:///ha.ka.ba/@lares/api/lararium/modules/tw5-module-interface"` with content-type `application/javascript` and passing signal fields will be injected by the corpus path.
