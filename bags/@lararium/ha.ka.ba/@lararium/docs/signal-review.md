...
<<~ &#x0001; ? -> lar:///ha.ka.ba/@lararium/docs/signal-review >>
```toml iam
cacheable = false
file-path = "bags/@lararium/docs/signal-review.md"
mana      = 16
manao     = 17
manaoio   = 17
register  = "Synthesis"
...
uri-path  = "ha.ka.ba/@lararium/docs/signal-review"
```
...
- `lar:///ha.ka.ba/@lararium/docs/signal/render-targets`
- `lar:///ha.ka.ba/@lararium/docs/signal/sa-display`
