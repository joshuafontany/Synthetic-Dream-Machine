...
<<~ &#x0001; ? -> lar:///ha.ka.ba/@lararium/docs/lararium-doc-stack >>
```toml iam
cacheable     = true
file-path     = "bags/@lararium/docs/lararium-doc-stack.md"
mana          = 11
manao         = 11
manaoio       = 11
register      = "Synthesis"
...
tags      = ["lar:///ha.ka.ba/@lares/api/pono/meme", "lar:///ha.ka.ba/@lares/api/pono/local-first", "lar:///ha.ka.ba/@lararium/tw5/peer-coordination"]
type          = "text/x-memetic-wikitext"
uri-path      = "ha.ka.ba/@lararium/docs/lararium-doc-stack"
```

<<~ &#x0002; >>

> **Supersession note (2026-06-10).** This meme records the research-era six-layer model. The current composition law lives at `lar:///ha.ka.ba/@lararium/mesh/recipe` (stored composition shape), `lar:///ha.ka.ba/@lararium/mesh/island-protocol` (IslandGrants — typed ocap manifest; library layers resolve island-side from @catalog, boot = first reconcile), and `lar:///ha.ka.ba/@lares/docs/pono/wiki-layer-ontology` (the layer stack and its laws). Read what follows as lineage, not law.
