...
<<~ &#x0001; ? -> lar:///ha.ka.ba/@lararium/docs/peer-discovery >>
```toml iam
cacheable = true
file-path = "bags/@lararium/docs/peer-discovery.md"
mana      = 18
manao     = 18
manaoio   = 17
...
tags      = ["lar:///ha.ka.ba/@lararium/tw5/peer-coordination", "lar:///ha.ka.ba/@lares/api/pono/local-first", "lar:///ha.ka.ba/@lararium/tw5/lar-uri-namespace", "lar:///ha.ka.ba/@lararium/tw5/lararium-doc-stack"]
type      = "text/x-memetic-wikitext"
uri-path  = "ha.ka.ba/@lararium/docs/peer-discovery"
```
